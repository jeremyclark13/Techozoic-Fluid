...
$options = array (
	array(	"name" => __("Layout","techozoic"),
		...
		array(	"name" => __("Fav Icon Image","techozoic"),
				"desc" => __("Fav Icon must be an .ico file.  Browse for a new image or chose previously uploaded image","techozoic"),		
            	"id" => "favicon_image",
		...
		array("name" => "<span id =\"post_text_font_size_out\" ><span id =\"post_text_font_size\" style=\"font-size:2em;line-height:1em\">".__("Post Text Font","techozoic")."</span></span>",
		...
		array(	"name" => __("Page Background Image","techozoic"),
				"desc" => __("Use a tiled image for best results Browse for a new image or chose previously uploaded image","techozoic"),		
            	"id" => "bg_image",
