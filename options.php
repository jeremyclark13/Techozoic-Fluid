...
function optionsframework_option_name() {
    ...
    $optionsframework_settings['id'] = 'techozoic-fluid';
...
function optionsframework_options() {
    ...
    $options[] = array("name" => __('Help Support Further Development', 'techozoic'),
        "type" => "info",
        "desc" => "<a href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=Q2UB936PZYYZ6' title='Help Support Development' target='_blank' ><img src='https://www.paypalobjects.com/en_US/i/btn/btn_paynow_SM.gif' /></a>");
